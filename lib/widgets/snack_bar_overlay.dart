...
import 'package:ai_image_annotator/utils/screen_utils.dart';
import 'package:ai_image_annotator/utils/theme_utils.dart';
import 'package:ai_image_annotator/widgets/description.dart';
import 'package:ai_image_annotator/widgets/header.dart';
...
void showError({
  ...
  _showMessage(
    text: text,
    title: title.isNotEmpty ? title : 'An error occurred',
...
void showInformation({
  ...
  _showMessage(
    text: text,
    title: title.isNotEmpty ? title : 'Information',
...
class _SnackbarOverlay extends StatefulWidget {
  const _SnackbarOverlay({Key? key}) : super(key: key);
